...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/shuvonmacbook/Documents/Django/weatherenv1'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/shuvonmacbook/Documents/Django/weatherenv1/bin/deactivate.nu'
